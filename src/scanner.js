...
// 단기 고점을 사는 것이다.
//
// ⚠ **이 신호는 수익 근거가 아니다.** 68~114일 표본에서는 기여 +37bps(t=4.30)로
// 보였으나, 455일 4037거래로 재검증하니 시각 대응 대조군 대비 기여가 +5.2±3.1bps
// (t=1.69, 유의하지 않음)로 줄고 순기대값은 -22.0bps(t=-7.95)였다.
// 짧은 표본에서 본 우위는 2026-04-28 이후 구간의 산물이었다.
// 돌파보다 덜 나쁠 뿐이며, 왕복 비용 ~28bps를 신호 우위 +5bps가 못 넘는다.
// 상세: docs/reversal-validation.md
//
